class AuctioneerUserModel {
    ...
    final AuctioneerUserClassModel? user;
    final String? token;

    factory AuctioneerUserModel.fromJson(Map<String, dynamic> json){ 
        return AuctioneerUserModel(
            success: json["success"],
            message: json["message"],
            user: json["user"] == null ? null : AuctioneerUserClassModel.fromJson(json["user"]),
            token: json["token"],
        );
    }
...
class AuctioneerUserClassModel {
    AuctioneerUserClassModel({
    ...
    factory AuctioneerUserClassModel.fromJson(Map<String, dynamic> json){ 
        return AuctioneerUserClassModel(
